...
class reg():
    ...
    def reg_train_step(self, z, zH, train=True):
        ...
        return L_reg_stage1, L_reg_stage2, L_reg_stage3
    ...
    def main(self):
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            for batch in range(self.batch_num):
                ...
                L_reg_stage1, L_reg_stage2, L_reg_stage3 = self.reg_train_step(tr_z_batch, tr_zH_batch, train=True)
            ...
            for batch in range(int(self.val_z.shape[0] / 10)):
                ...
                L_reg_stage1, L_reg_stage2, L_reg_stage3 = self.reg_train_step(val_z_batch, val_zH_batch, train=False)
            ...
            for batch in range(int(self.te_z.shape[0] / 10)):
                ...
                L_reg_stage1, L_reg_stage2, L_reg_stage3 = self.reg_train_step(te_z_batch, te_zH_batch, train=False)
            ...
            print('------------------------------------------------')
            self.reg.save_weights(f'weights/reg')
